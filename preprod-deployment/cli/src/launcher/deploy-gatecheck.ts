...
async function main() {
  ...
  try {
    ...
    // For automated CI deployments, we provide the hashed adminPk that matches our known adminSk.
    const adminPk = new Uint8Array(Buffer.from('9a8b22386114d81db368cfaa9813fe5f0840dc8df38ad15202766a25c0a94238', 'hex'));
    
    console.log("================================================================================");
    console.log("WARNING: This is an automated CI deployment. A dummy admin PK was used.");
    console.log("================================================================================");

    // Use a random metaHash to ensure the generated contract address is unique on the network,
    // avoiding Custom Error 170 (Contract Already Exists).
    const metaHash = new Uint8Array(crypto.randomBytes(32));
